...
public class TeaVMBuilder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("com/monstrous/app/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("com.monstrous.app.reflect");
